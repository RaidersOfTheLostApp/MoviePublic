...
exports.up = function(knex, Promise) {
  return Promise.all([
    ...
    knex.schema.createTableIfNotExists('profiles', function(table) {
      ...
      table.jsonb('follow_imdbMovies').nullable();
    ...
    knex.schema.createTableIfNotExists('movies', function(table) {
      table.increments('id').unsigned().primary();
      table.text('mongo_id').notNullable().unique();
    ...
    knex.schema.createTableIfNotExists('upcoming_movies', function(table) {
      table.increments('id').unsigned().primary();
      table.integer('imdb_id').notNullable().unique();
      table.text('title').notNullable();
      table.smallint('year').nullable();
      table.text('release_date').nullable();
      table.jsonb('genres').nullable();
...
exports.down = function(knex, Promise) {
  return Promise.all([
    ...
    knex.schema.dropTable('crew'),
    knex.schema.dropTable('profiles'),
    knex.schema.dropTable('upcoming_movies')
  ]);
};
